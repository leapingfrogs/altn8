...
public abstract class BaseFileAction extends AnAction
{
    ...
    private void openFiles( VirtualFile[] virtualFiles, Project currentProject )
    {
    ...
    void openFiles( String[] alternateFileNames, Project currentProject, Module currentModule )
    {
